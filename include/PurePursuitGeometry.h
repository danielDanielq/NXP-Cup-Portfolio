...
[[maybe_unused]]static float purePursuitComputeSteeringWheelAngle(Point2D carPos, LineMQ wayPoints, float carLength, float lookAheadDistance) {
	float temp;
...
[[maybe_unused]]static PurePursuitInfo purePursuitComputeMQ(Point2D carPos, LineMQ wayPoints, float carLength, float lookAheadDistance) {
	float temp;
